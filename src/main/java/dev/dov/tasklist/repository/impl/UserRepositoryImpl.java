...
import dev.dov.tasklist.repository.mappers.UserRowMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    public void update(User user) {
        try{
            ...
            throw new ResourceMappingException("Exception while update user");
        }
    }
    ...
    public void insertUserRole(Long userId, Role role) {
        try{
            ...
            exception.printStackTrace();
            throw new ResourceMappingException("Exception while insert user role");
        }
    }
    ...
    public boolean isTaskOwner(Long userId, Long taskId) {
        try{
            ...
            throw new ResourceMappingException("Exception while checking is user task owner");
        }
    }
